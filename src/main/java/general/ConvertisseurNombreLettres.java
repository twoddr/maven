 ...
 * Title: Convert</p>
 * <p>
 * Description: Convert Number in letter (Arab and French) </p>
 * <p>
 * Copyright: Copyright (c) 2014</p>
 * <p>
 * Company: Rafik ZEBIDA</p>
 *
 * @author Rafik ZEBIDA
 * @version 1.0
 */
...
public abstract class ConvertisseurNombreLettres {
    ...
    public static String AR(String nombre, String devise, String sou) {
        ...
        if (nombre.equals("#Erreur")) {
            result = "\u062e\u0637\u0623#";
        } else if (nombre.equals("#Trop grand")) {
            result = "\u0643\u0628\u064a\u0631 \u062c\u062F\u0627#";
        } else {
            result = "";
            while (rang > 0) {
                ...
                switch (Integer.parseInt(cent)) {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        result += " \u0648" + n1[Integer.parseInt(cent)] + " \u0645\u0627\u0626\u0629";    //æ× ãÇÆÉ
                }
    ...
    public static String FR(String nombre) {
        ...
        if ((nombre.equals("#Erreur")) || (nombre.equals("#Trop grand"))) {
            ...
            switch (Integer.parseInt(frac)) {
                ...
                case 18:
                case 19:
                    result += n1[Integer.parseInt(frac)];
                    break;
                case 71:
                case 72:
                case 73:
                ...
                case 78:
                case 79:
                    result += n70[Integer.parseInt(un) - 1];
                    break;
                case 91:
                case 92:
                case 93:
                ...
                case 98:
                case 99:
                    result += n90[Integer.parseInt(un) - 1];
                    break;
                default:
                    if ((!dix.equals("0")) && (un.equals("1"))) {
                        result += n10[Integer.parseInt(dix)] + " et Un ";
                    } else {
                        result += n10[Integer.parseInt(dix)] + n1[Integer.parseInt(un)];
                    }
            }
